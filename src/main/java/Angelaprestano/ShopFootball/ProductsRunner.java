...
public class ProductsRunner implements CommandLineRunner {
   ...
   private ProductsService productsService;
    ...
    public void createProducts() {
        ...
        Products tshir1 = new Products("https://store.inter.it/dw/image/v2/BJBQ_PRD/on/demandware.static/-/Sites-inter-master-catalog/default/dwe3310c44/images/large/23I002U6602_01.jpg?sw=1400&q=80", "Polo Inter", "Polo nera, realizzata in cotone. Presenta una scritta piccola a destra, realizzata in grigio", 24.99, "price_1OmZacGUnxyubwNLx6EGF4TP",  "Nero", Size.L, Categories.MAN, TypeofProduct.TSHIRT);
        ...
        Products tshir14 = new Products("https://store.inter.it/dw/image/v2/BJBQ_PRD/on/demandware.static/-/Sites-inter-master-catalog/default/dwa3f2ddd3/images/large/23I002M10205_01.jpg?sw=1400&q=80", "Maglietta Galaxy", "Maglietta azzurra, con designer cielo e stemma centrale", 32.99, "Azzurro", Size.M, Categories.MAN, TypeofProduct.TSHIRT);
        productsDAO.save(tshir14);
       ...
       // TUTE DONNA
        ...
        Products tshirKid6 = new Products("https://store.inter.it/dw/image/v2/BJBQ_PRD/on/demandware.static/-/Sites-inter-master-catalog/default/dwc94af5da/images/detail/22L002K11502_03.jpg?sw=700&sfrm=jpg&q=80", "Tshirt Inter Bambino", "Maglietta bianca, realizzata in cotone, presenta una scritta centrale", 22.99, "price_1OmyN7GUnxyubwNLenEJsKiW","Nero", Size.TWELVE_YEARS, Categories.KIDS, TypeofProduct.TSHIRT);
        productsDAO.save(tshirKid6);
        Products tshirKid7 = new Products("https://store.inter.it/dw/image/v2/BJBQ_PRD/on/demandware.static/-/Sites-inter-master-catalog/default/dw3fde4a82/images/large/23I002K7611_01.jpg?sw=1400&q=80", "Tshirt Inter Bambino", "Maglietta grigia, realizzata in cotone con manica corta. Presenta un serpente centrale con stemma blu centrale", 29.99, "Grigio", Size.EIGHT_YEARS, Categories.KIDS, TypeofProduct.TSHIRT);
        productsDAO.save(tshirKid7);
        Products tshirKid8 = new Products("https://store.inter.it/dw/image/v2/BJBQ_PRD/on/demandware.static/-/Sites-inter-master-catalog/default/dwc256db03/images/large/23I002K7711_01.jpg?sw=1400&q=80", "Tshirt Inter Bambino", "Maglietta grigia, realizzata in cotone con manica lunga. Presenta un serpente centrale con stemma blu centrale", 34.99, "Grigio", Size.SIX_YEARS, Categories.KIDS, TypeofProduct.TSHIRT);
        productsDAO.save(tshirKid8);
        Products tshirKid9 = new Products("https://store.inter.it/dw/image/v2/BJBQ_PRD/on/demandware.static/-/Sites-inter-master-catalog/default/dw93587217/images/large/23L002K9802_01.jpg?sw=1400&q=80", "Tshirt Inter Bambino", "Maglietta nera, manica corta, della Champions League. Presenta il disegno di un pallone da calcio, con scritta Champions League e stemma inter", 24.99, "price_1OqGcBGUnxyubwNLGYbwKbH4", "Nero", Size.SIX_YEARS, Categories.KIDS, TypeofProduct.TSHIRT);
        productsDAO.save(tshirKid9);
